...
import { fetchAllStudents, fetchStudentById, fetchMyProfile, updateMyProfileSelf, addStudent, updateStudentProfile, removeStudent, getDashboardStats, batchCreateStudentsHandler } from '../../controllers/studentController.js';
...
router.post('/batch', verifyRole(['ADMIN','COORDINATOR']), batchCreateStudentsHandler);
