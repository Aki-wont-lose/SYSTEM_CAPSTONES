          ...
          <div className="mt-2 bg-sti-blue rounded-xl px-4 py-2.5 flex items-center justify-between">
            <div>
              <p className="text-white font-bold text-sm">
                Hi, {student?.firstName}! {student?.ojt_status === 'COMPLETED' ? '≡ƒÄë' : ''}
              </p>
        ...
        <div className="lg:col-span-1 space-y-4">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-card border border-black/5 dark:border-white/5 p-3">
            ...
            <div className="space-y-1.5">
              <button onClick={()=>navigate('/my-dtr')} className="w-full text-left text-xs px-3 py-2 rounded-lg hover:bg-sti-gray-light dark:hover:bg-white/5">≡ƒô╖ Time In / Out</button>
              <button onClick={()=>navigate('/requirements')} className="w-full text-left text-xs px-3 py-2 rounded-lg hover:bg-sti-gray-light dark:hover:bg-white/5">≡ƒôä Requirements</button>
              <button onClick={()=>navigate('/find-company')} className="w-full text-left text-xs px-3 py-2 rounded-lg hover:bg-sti-gray-light dark:hover:bg-white/5">≡ƒÅó Find Company</button>
            </div>
          </div>
        </div>
      </div>
